...
exports.POST = async (req, res) => {
  ...
  db.query(sql, [participantid, employeeid, employeeid], (err, result) => {
    ...
    const case_notes_housing_filepath = path.join(__dirname, `../../../ease_uploads/${case_notes_housing_filename}`)
    const case_notes_housing_filename_original = result[0].case_notes_housing_filename_original;
    ...
    res.download(case_notes_housing_filepath, case_notes_housing_filename_original, (err) => {
