...
exports.POST = (req, res) => {
  ...
  const sql = `
    ...
    WHERE
      t.entry >= convert_tz(date_format(convert_tz(utc_timestamp(), '+00:00', ?), "%Y-%m-%d 00:00:00"), ?, '+00:00')
    AND
      t.entry <= convert_tz(date_format(convert_tz(utc_timestamp(), '+00:00', ?), '%Y-%m-%d 23:59:59'), ?, '+00:00')
    AND
      t.employeeid = ?
    ;
  `;
