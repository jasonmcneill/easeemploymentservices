...
async function onSubmit(e) {
  ...
  const endpoint = "/api/provider-add";
    ...
    .then((data) => {
      ...
      switch (data.msg) {
        ...
        case "unable to query for duplicate company name":
          hideSpinner(content, spinner);
          showError(
            "There was a technical glitch preventing the system from adding the housing provider.  Please wait a moment then try again.",
            "Database is Down"
          );
          break;
        ...
        case "invalid phone number for region":
          ...
          break;
        case "unable to insert new provider":
          hideSpinner(content, spinner);
          showError(
            "There was a technical glitch preventing the system from adding the housing provider.  Please wait a moment then try again.",
            "Database is Down"
          ...
          break;
        case "provider added successfully":
          addToast(
            "The housing provider was added successfully.",
            "Provider Added",
            "success"
          );
          window.location.href = "../";
